...
" these two sentences are for disabling the <f1> mapping configured by this file
imap <F1> <Esc>:up<CR>:!open /Applications/Skim.app<CR><CR>
nmap <F1> :up<CR>:!open /Applications/Skim.app<CR><CR>
