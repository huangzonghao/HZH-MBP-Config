...
function! s:TaskList()
    ...
    nnoremap <buffer> <silent> p :call <sid>Exit(-1)<cr>
    " some of my personal preferences --Thu Aug  6 10:41:31 2015
    nmap <buffer> <silent> t <Plug>(easymotion-j)
    nmap <buffer> <silent> e <Plug>(easymotion-k)
