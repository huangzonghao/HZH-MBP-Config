...
function! s:JumpCd(cmd, ...)
  ...
  if v:shell_error != 0
    ...
    exe 'cd '.escape(path, ' ')
    pwd
    " to list the file tree when jump to a new dir
    " this fulfills my requirement better
    " --huangzonghao Sat Jan 27 19:02:03 EST 2018
    call g:NERDTreeCreator.CreatePrimary('')
  endif
endfunction
