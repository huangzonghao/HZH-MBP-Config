...
let s:N1 = [ '#ffffff' , '#00875f' , 255 , 29  ]
let s:N2 = [ '#005f00' , '#00df87' , 22  , 42  ]
let s:N3 = [ '#005f5f' , '#afff87' , 23  , 156 ]
...
let s:I1 = [ '#ffffff' , '#005fff' , 255 , 27  ]
let s:I2 = [ '#000087' , '#00dfff' , 18  , 45  ]
let s:I3 = [ '#005fff' , '#afffff' , 27  , 159 ]
